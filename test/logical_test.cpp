...
static_assert(brigand::not_<brigand::not_<brigand::true_>>::value == true, "invalid not result");
...
static_assert(brigand::and_<brigand::not_<brigand::true_>, brigand::false_>::value == false, "invalid and/not result");
