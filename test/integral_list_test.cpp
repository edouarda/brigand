...
static_assert(std::is_same<brigand::push_back<brigand::empty_list, n_>, list1>::value, "invalid push back int");
static_assert(std::is_same<brigand::push_front<brigand::empty_list, n_>, list1>::value, "invalid push back int");
...
static_assert(std::is_same<brigand::pop_front<list2>, brigand::empty_list>::value, "invalid pop front result");

static_assert(std::is_same<brigand::pop_back<listref>, list1>::value, "invalid pop back result");
static_assert(std::is_same<brigand::pop_back<list1>, brigand::empty_list>::value, "invalid pop back result");
