...
brigand::partition< odd_list, brigand::quote<is_odd>> partition_test1 = brigand::pair<odd_list,      size_t_list<>>{};
brigand::partition<even_list, brigand::quote<is_odd>> partition_test2 = brigand::pair<size_t_list<>, even_list>{};
brigand::partition<full_list, brigand::quote<is_odd>> partition_test3 = brigand::pair<odd_list,      even_list>{};
