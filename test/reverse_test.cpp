...
static_assert(std::is_same<one_list, brigand::reverse<one_list>>::value, "reversing a one elment list should return the same list");

using two_list = brigand::list<char, int>;
using reversed_two_list = brigand::list<int, char>;

static_assert(std::is_same<reversed_two_list, brigand::reverse<two_list>>::value, "invalid reverse algorithm");
...
static_assert(std::is_same<reversed_large_list, brigand::reverse<large_list>>::value, "invalid reverse algorithm");
