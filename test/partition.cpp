...
static_assert ( std::is_same<result::first_type,  even_list>::value &&
                std::is_same<result::second_type,  odd_list>::value
...
namespace test4 {
using result = brigand::partition<brigand::list<>, is_odd>;
static_assert ( std::is_same<result::first_type,  brigand::empty_list>::value &&
                std::is_same<result::second_type, brigand::empty_list>::value
...
static_assert ( std::is_same<result::first_type,  brigand::list<int, char>>::value &&
                std::is_same<result::second_type, brigand::list<float, double>>::value
