...
static_assert(std::is_same<brigand::if_<std::true_type, long, bool>::type, long>::value, "invalid if_ result");
static_assert(std::is_same<brigand::if_<std::false_type, long, bool>::type, bool>::value, "invalid if_ result");
