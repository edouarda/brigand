...
static_assert(std::is_same<brigand::remove_if<remove_test_int_list, brigand::unary_compose<std::is_same, brigand::int_<2>>::type>, brigand::list<brigand::int_<1>, brigand::int_<0>, brigand::int_<0>>>::value, "invalid remove_if result");
...
static_assert(std::is_same<brigand::remove_if<remove_test_list, brigand::unary_compose<std::is_same, double>::type>, brigand::list<int, bool, int, char, float>>::value, "invalid remove_if result");
