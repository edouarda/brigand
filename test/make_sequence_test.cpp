...
static_assert(std::is_same<brigand::make_sequence<brigand::int32_t<2>, 4, brigand::quote<brigand::prev>>,
  brigand::integral_list<std::int32_t, 2, 1, 0, -1>>::value, "invalid make_sequence result");
static_assert(std::is_same<brigand::make_sequence<brigand::uint32_t<0>, 10>,
