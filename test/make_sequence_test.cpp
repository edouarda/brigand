...
static_assert(std::is_same<brigand::as_integral_list<brigand::make_sequence<brigand::uint32_t<2>, 4, brigand::prev>>,
  brigand::integral_list<std::uint32_t, 2, 1, 0, -1>>::value, "invalid make_sequence result");
